...
def select_relevant_profiles(all_profiles):
    ...
    #criteria:
    # - the profil is public
    # - AGE specified, all profiles above at least 15 years
    # - GENDER SPECIFIED, man or woman
...
def test_load_and_select_profiles_and_edges():
    
    ##load and select relevant profiles, then filter and undirect edges
    
    print("loading profiles")
    
    # TODO: Cutting 40K observations and replace the gender string as NA, to be able to calculate the prediction models
